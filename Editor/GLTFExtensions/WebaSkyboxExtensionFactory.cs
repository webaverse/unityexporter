...
public class WebaSkyboxExtensionFactory : WebaExtensionFactory
{
    public override string GetExtensionName() { return "WebaSkybox"; }
    ...
    {
        WebaSkyboxExtension extension = new WebaSkyboxExtension();
        ...
        else if (camera.clearFlags == CameraClearFlags.Skybox)
        {
            ...
            if (mat == null)
            {
                Debug.LogWarning("Use skybox as camera clear flag, but skybox is not defined, ignore...");
                return;
            }
        ...
        {
            Utils.ThrowException("Only support camera clearFlag 'Solid' and 'Skybox' now!");
        }
