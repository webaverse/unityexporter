...
public class WebaImageBasedLightingExtension : Extension
{
    public struct Light
    {
        public float[][] shCoefficients;
        public float diffuWebatensity;
        public int brdfLUT;
        public int specMap;
    ...
    public JProperty Serialize()
    {
        ...
        if (isGlobal)
        {
            ...
            foreach (var light in lights)
            {
                ...
                l.Add("diffuse", new JObject(
                    ...
                    new JProperty("intensity", light.diffuWebatensity),
        ...
        return new JProperty(ExtensionManager.GetExtensionName(typeof(WebaImageBasedLightingExtensionFactory)), value);
    }
}