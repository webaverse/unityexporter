...
public class WebaCubeTextureExtensionFactory : WebaExtensionFactory
{
    public override string GetExtensionName() { return "WebaCubeTexture"; }
    ...
    {
        WebaCubeTextureExtension extension;
        ...
        {
            extension = new WebaCubeTextureExtension();
            AddExtension(extensions, extension);
        }
        else
        {
            extension = (WebaCubeTextureExtension)extensions[ExtensionName];
        }
        ...
        else
        {
            if (cubemap == null)
            {
                Utils.ThrowException("It seems that cubemap is not set to material!");
            }
        ...
        foreach (var face in faces)
        {
            ...
            {
                Utils.ThrowException("Cube texture face must have same width and height:" + origAssetPathes[i]);
            }
