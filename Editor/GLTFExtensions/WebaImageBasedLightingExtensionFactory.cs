...
public class WebaImageBasedLightingExtensionFactory : WebaExtensionFactory
{
    public override string GetExtensionName() { return "WebaImageBasedLighting"; }
    ...
    public override void BeforeExport()
    {
        ...
        var brdfPath = "Assets/WebaverseUnityExporter/Shaders/brdfLUT.jpg";
    ...
    public override void Serialize(ExporterEntry entry, Dictionary<string, Extension> extensions, UnityEngine.Object component = null, object options = null)
    {
        ...
        var hasReflection = ExporterSettings.Lighting.reflection && mat.GetInt("envReflection") != (int)WebaPBRShaderGUI.EnvReflection.Off;
        ...
        WebaImageBasedLightingExtension globalExtension;
        if (!entry.root.Extensions.ContainsKey(ExtensionName))
        {
            globalExtension = new WebaImageBasedLightingExtension();
            globalExtension.isGlobal = true;
            AddExtension(entry.root.Extensions, globalExtension);
        }
        else
        {
            globalExtension = (WebaImageBasedLightingExtension)entry.root.Extensions[ExtensionName];
        }

        var extension = new WebaImageBasedLightingExtension();
        ...
        var light = new WebaImageBasedLightingExtension.Light { specMap = -1 };
        ...
        light.diffuWebatensity = diffuWebatensity;
        ...
        else
        {
            ...
            if (skybox == null)
            {
                Debug.LogWarning("Use skybox as relfection source, but skybox is not defined, ignore...");
                return;
            }
            ...
            {
                Utils.ThrowException("Only support 'Skybox/Cubemap', 'Skybox/6 Side', 'Skybox/Panormic'");
            }
        }
    ...
    {
        return new WebaImageBasedLightingExtension();
    }
