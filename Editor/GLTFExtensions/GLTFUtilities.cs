...
public class GLTFUtilities
{
    ...
    static ComputeShader FastMapper
    {
        get
        {
            if(_fastMapper == null)
            {
                _fastMapper = AssetDatabase.LoadAssetAtPath<ComputeShader>(@"Assets/Webaverse/Code/Shaders/FastMap.compute");
            }
            return _fastMapper;
        }
    }
    private const string _whiteTexPath = @"Assets/Webaverse/Code/GLTF/Utilities/WhiteTex.png";
    ...
    private const string _blackTexPath = @"Assets/Webaverse/Code/Utilities/BlackTex.png";
