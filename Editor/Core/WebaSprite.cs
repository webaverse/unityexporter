...
[AddComponentMenu("Weba/Core Components/Weba Sprite"), ExecuteInEditMode]
public class WebaSprite : MonoBehaviour
{
    private static string SPRITE_DATA_DIR_PATH = "Assets/WebaSpriteData";

    public float width;
    public float height;
    public WebaAtlas atlas;
    ...
    public void Generate()
    {
        ...
        if (!GetComponent<MeshRenderer>())
        {
            ...
            material = new Material(Shader.Find("Weba/Sprite"));
    ...
    public void SetFrame(WebaAtlas atlas, string frameName)
    {
    ...
    [MenuItem("GameObject/Weba/Create Sprite", priority = 11)]
    private static void CreateGO()
    {
        var go = new GameObject("WebaSprite");
        var sprite = go.AddComponent<WebaSprite>();
        sprite.width = 1;
        sprite.height = 1;
        sprite.Generate();
    }
...
[CustomEditor(typeof(WebaSprite))]
public class WebaSpriteEditor : Editor
{
    public override void OnInspectorGUI()
    {
        WebaSprite sprite = (WebaSprite)target;
