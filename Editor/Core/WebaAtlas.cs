...
[CreateAssetMenu(fileName = "WebaAtlas", menuName = "Weba/Atlas")]
public class WebaAtlas : ScriptableObject
{
    ...
    public void Pack()
    {
        ...
        if (_PURE_WHITE == null)
        {
            _PURE_WHITE = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/WebaverseUnityExporter/Shaders/white.png");
        }
...
[CustomEditor(typeof(WebaAtlas))]
public class WebaAtlasEditor : Editor
{
    public override void OnInspectorGUI()
    {
        WebaAtlas atlas = (WebaAtlas)target;
    ...
    private void DoImport(WebaAtlas atlas)
    {
